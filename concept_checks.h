...
/* helper function for avoiding compiler warnings about unused variables 輔助函數，避免編譯器警告未使用的變量*/
...
// Some Functon Object Checks 一些函數對象的檢查
