  ...
  _Rope_iterator_base<_CharT,_Alloc>& __x)
{
	...
	case _RopeRep::_S_leaf:			//	如果leaf的tag是 _RopeRep::_S_leaf
	    __x._M_buf_start = 
	      ((_Rope_RopeLeaf<_CharT,_Alloc>*)__leaf)->_M_data;		// start
	    __x._M_buf_ptr = __x._M_buf_start + (__pos - __leaf_pos);	// ptr=start + 相對pos
	    __x._M_buf_end = __x._M_buf_start + __leaf->_M_size;		//end=start+size
	    break;
